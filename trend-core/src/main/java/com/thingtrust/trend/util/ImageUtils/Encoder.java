...
public class Encoder {
    ...
    int maxbits = Encoder.BITS; // user settable max # bits/code
    int maxcode; // maximum code, given n_bits
    // General DEFINEs
    int maxmaxcode = 1 << Encoder.BITS; // should NEVER generate this code
    int[] htab = new int[Encoder.HSIZE];
    ...
    int[] codetab = new int[Encoder.HSIZE];
    int hsize = Encoder.HSIZE; // for dynamic table sizing
    ...
    //----------------------------------------------------------------------------
    Encoder(final int width, final int height, final byte[] pixels, final int color_depth) {
        imgW = width;
        imgH = height;
        pixAry = pixels;
